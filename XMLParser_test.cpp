...
TEST_CASE( "Test XMLParser parseTokenizedInput1", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "</a>content</a>";
		bool success;
		success = myXMLParser.tokenizeInputString(testString);
		REQUIRE(success);
		success = myXMLParser.parseTokenizedInput();
...
TEST_CASE( "Test XMLParser parseTokenizedInput2", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "<a>content</a>";
		bool success;
...
TEST_CASE( "Test XMLParser parseTokenizedInput3", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "<a/>content</a>";
		bool success;
...
TEST_CASE( "Test XMLParser parseTokenizedInput4", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "<a>content<a>";
		bool success;
...
TEST_CASE( "Test XMLParser parseTokenizedInput5", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "<a>content<a/>";
		bool success;
...
TEST_CASE( "Test XMLParser parseTokenizedInput6", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "<a/>content<a/>";
		bool success;
...
TEST_CASE( "Test XMLParser parseTokenizedInput7", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "<note c=4 b=fasnhdkjn>content<a/></note>";
		bool success;
		success = myXMLParser.tokenizeInputString(testString);
		REQUIRE(success);
		success = myXMLParser.parseTokenizedInput();
...
TEST_CASE( "Test XMLParser parseTokenizedInput8", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "<note c=4 b=fasnhdkjn>content<a/></Note>";
		bool success;
...
TEST_CASE( "Test XMLParser getFrequency1", "[XMLParser]" )
{
		XMLParser myXMLParser;
		string testString = "<note c=4 b=fasnhdkjn>content<a/></note>";
		bool success;
		...
		REQUIRE(myXMLParser.containsElementName("note")==true);
		REQUIRE(myXMLParser.frequencyElementName("a")==1);
		REQUIRE(myXMLParser.containsElementName("a")==true);

}

TEST_CASE( "Test XMLParser getFrequency2", "[XMLParser]" )
{
		XMLParser myXMLParser;
		REQUIRE(myXMLParser.frequencyElementName("note")==0);
		REQUIRE(myXMLParser.containsElementName("note")==false);
		REQUIRE(myXMLParser.frequencyElementName("a")==0);
		REQUIRE(myXMLParser.containsElementName("a")==false);
		string testString = "<note c=4 b=fasnhdkjn>content<a/></note><d>";
		bool success;
		success = myXMLParser.tokenizeInputString(testString);
		REQUIRE(success);
		success = myXMLParser.parseTokenizedInput();
...
//From more tests
//--------------------------------------------------------------
TEST_CASE( "Test Bag add2", "[XMLParser]" )
{
	   INFO("Hint: testing Bag add()");
		// Create a Bag to hold ints
		Bag<int> intBag;
...
TEST_CASE( "Test Stack push2", "[XMLParser]" )
{
	   INFO("Hint: testing Stack push()");
		// Create a Stack to hold ints
		Stack<int> intStack;
...
TEST_CASE( "Test XMLParser tokenizeInputStringe", "[XMLParser]" )
{
	   INFO("Hint: tokenize single element test of XMLParse");
		// Create an instance of XMLParse
		XMLParser myXMLParser;
